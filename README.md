...
右键托盘图标可以打开菜单，支持切换小窗/大窗、置顶、开机自启动、设置自动刷新秒数、重启、查看版本号和退出。
...
工具默认每 30 秒自动刷新一次。可在托盘或弹窗右键菜单的“自动刷新”子菜单中选择 `5s`、`10s`、`20s`、`30s`、`60s`、`5min`、`10min`、`20min`、`30min`、`60min`，也可以点击窗口刷新图标手动刷新。
